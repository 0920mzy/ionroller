 ...
 * apidoc:0.9.29 http://www.apidoc.me/gilt/ionroller-api/0.0.2-dev/play_2_3_client
 */
...
object Bindables {
  ...
  import com.gilt.ionroller.api.v0.models._
...
object Constants {
  ...
  val UserAgent = "apidoc:0.9.29 http://www.apidoc.me/gilt/ionroller-api/0.0.2-dev/play_2_3_client"
...
class Client(
  ...
  private[this] val logger = play.api.Logger("com.gilt.ionroller.api.v0.Client")

  logger.info(s"Initializing com.gilt.ionroller.api.v0.Client for url $apiUrl")
  ...
  object Services extends Services {
    override def get()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.ionroller.api.v0.models.Service]] = {
      _executeRequest("GET", s"/services").map {
        case r if r.status == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Seq[com.gilt.ionroller.api.v0.models.Service]", r, _.validate[Seq[com.gilt.ionroller.api.v0.models.Service]])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
      }
    }
    ...
    override def getByServiceName(
      ...
      _executeRequest("GET", s"/services/${play.utils.UriEncoding.encodePathSegment(serviceName, "UTF-8")}").map {
        case r if r.status == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("com.gilt.ionroller.api.v0.models.Service", r, _.validate[com.gilt.ionroller.api.v0.models.Service])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
      }
    }
    ...
    override def putConfigByServiceName(
      ...
      _executeRequest("PUT", s"/services/${play.utils.UriEncoding.encodePathSegment(serviceName, "UTF-8")}/config", body = Some(payload)).map {
        ...
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204")
      }
    }
    ...
    override def getConfigsByServiceName(
      ...
      _executeRequest("GET", s"/services/${play.utils.UriEncoding.encodePathSegment(serviceName, "UTF-8")}/configs", queryParameters = queryParameters).map {
        case r if r.status == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Seq[com.gilt.ionroller.api.v0.models.ServiceConfig]", r, _.validate[Seq[com.gilt.ionroller.api.v0.models.ServiceConfig]])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
      }
    }
    ...
    override def getConfigByServiceName(
      ...
      _executeRequest("GET", s"/services/${play.utils.UriEncoding.encodePathSegment(serviceName, "UTF-8")}/config").map {
        case r if r.status == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("com.gilt.ionroller.api.v0.models.ServiceConfig", r, _.validate[com.gilt.ionroller.api.v0.models.ServiceConfig])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
      }
    }
    ...
    override def postReleaseByServiceName(
      ...
      _executeRequest("POST", s"/services/${play.utils.UriEncoding.encodePathSegment(serviceName, "UTF-8")}/release", body = Some(payload)).map {
        case r if r.status == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Long", r, _.validate[Long])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
      }
    }
  ...
  def parseJson[T](
    ...
    f(play.api.libs.json.Json.parse(r.body)) match {
      ...
      case play.api.libs.json.JsError(errors) => {
        throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
      }
    }
  }
