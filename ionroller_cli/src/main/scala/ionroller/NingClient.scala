 ...
 * apidoc:0.9.29 http://www.apidoc.me/gilt/ionroller-api/0.0.2-dev/ning_1_9_client
 */
package com.gilt.ionroller.api.v0.models {
...
case class EbConfig(
                     ...
                     settings: Seq[com.gilt.ionroller.api.v0.models.OptionSetting],
...
case class Environment(
                        release: com.gilt.ionroller.api.v0.models.Release,
                        health: String
                        )
...
case class Release(
                    ...
                    rolloutStatus: _root_.scala.Option[com.gilt.ionroller.api.v0.models.RolloutStatus] = None
                    )
...
case class Service(
                    name: String,
                    state: com.gilt.ionroller.api.v0.models.ServiceState
                    )
...
case class ServiceConfig(
                          ...
                          hostedZoneId: String,
                          awsAccountId: String,
                          externalElb: _root_.scala.Option[com.gilt.ionroller.api.v0.models.ElbSettings] = None,
                          serviceRole: String,
                          image: String,
                          portMappings: Seq[com.gilt.ionroller.api.v0.models.PortMapping],
                          volumeMappings: _root_.scala.Option[Seq[com.gilt.ionroller.api.v0.models.VolumeMapping]] = None,
                          runArgs: Seq[String],
                          eb: com.gilt.ionroller.api.v0.models.EbConfig,
...
case class ServiceCurrentState(
                                environments: Seq[com.gilt.ionroller.api.v0.models.Environment]
                                )
...
case class ServiceDesiredState(
                                current: _root_.scala.Option[com.gilt.ionroller.api.v0.models.Release] = None,
                                next: _root_.scala.Option[com.gilt.ionroller.api.v0.models.Release] = None,
                                future: _root_.scala.Option[com.gilt.ionroller.api.v0.models.Release] = None
                                )
...
case class ServiceState(
                         current: com.gilt.ionroller.api.v0.models.ServiceCurrentState,
                         desired: _root_.scala.Option[com.gilt.ionroller.api.v0.models.ServiceDesiredState] = None
                         )
...
package object json {
  ...
  implicit def jsonReadsIonrollerAPIEbConfig: play.api.libs.json.Reads[EbConfig] = {
    (
      (__ \ "deployment_bucket").read[String] and
        ...
        (__ \ "settings").read[Seq[com.gilt.ionroller.api.v0.models.OptionSetting]] and
  ...
  implicit def jsonWritesIonrollerAPIEbConfig: play.api.libs.json.Writes[EbConfig] = {
    (
      (__ \ "deployment_bucket").write[String] and
        ...
        (__ \ "settings").write[Seq[com.gilt.ionroller.api.v0.models.OptionSetting]] and
  ...
  implicit def jsonReadsIonrollerAPIEnvironment: play.api.libs.json.Reads[Environment] = {
    (
      (__ \ "release").read[com.gilt.ionroller.api.v0.models.Release] and
  ...
  implicit def jsonWritesIonrollerAPIEnvironment: play.api.libs.json.Writes[Environment] = {
    (
      (__ \ "release").write[com.gilt.ionroller.api.v0.models.Release] and
  ...
  implicit def jsonReadsIonrollerAPIRelease: play.api.libs.json.Reads[Release] = {
    (
      (__ \ "image").read[String] and
        ...
        (__ \ "rollout_status").readNullable[com.gilt.ionroller.api.v0.models.RolloutStatus]
      )(Release.apply _)
  }
  ...
  implicit def jsonWritesIonrollerAPIRelease: play.api.libs.json.Writes[Release] = {
    (
      (__ \ "image").write[String] and
        ...
        (__ \ "rollout_status").writeNullable[com.gilt.ionroller.api.v0.models.RolloutStatus]
  ...
  implicit def jsonReadsIonrollerAPIService: play.api.libs.json.Reads[Service] = {
    (
      (__ \ "name").read[String] and
        (__ \ "state").read[com.gilt.ionroller.api.v0.models.ServiceState]
      )(Service.apply _)
  }
  ...
  implicit def jsonWritesIonrollerAPIService: play.api.libs.json.Writes[Service] = {
    (
      (__ \ "name").write[String] and
        (__ \ "state").write[com.gilt.ionroller.api.v0.models.ServiceState]
  ...
  implicit def jsonReadsIonrollerAPIServiceConfig: play.api.libs.json.Reads[ServiceConfig] = {
    (
      (__ \ "url").read[String] and
        ...
        (__ \ "external_elb").readNullable[com.gilt.ionroller.api.v0.models.ElbSettings] and
        (__ \ "service_role").read[String] and
        (__ \ "image").read[String] and
        (__ \ "port_mappings").read[Seq[com.gilt.ionroller.api.v0.models.PortMapping]] and
        (__ \ "volume_mappings").readNullable[Seq[com.gilt.ionroller.api.v0.models.VolumeMapping]] and
        (__ \ "run_args").read[Seq[String]] and
        (__ \ "eb").read[com.gilt.ionroller.api.v0.models.EbConfig] and
  ...
  implicit def jsonWritesIonrollerAPIServiceConfig: play.api.libs.json.Writes[ServiceConfig] = {
    (
      (__ \ "url").write[String] and
        ...
        (__ \ "external_elb").writeNullable[com.gilt.ionroller.api.v0.models.ElbSettings] and
        (__ \ "service_role").write[String] and
        (__ \ "image").write[String] and
        (__ \ "port_mappings").write[Seq[com.gilt.ionroller.api.v0.models.PortMapping]] and
        (__ \ "volume_mappings").writeNullable[Seq[com.gilt.ionroller.api.v0.models.VolumeMapping]] and
        (__ \ "run_args").write[Seq[String]] and
        (__ \ "eb").write[com.gilt.ionroller.api.v0.models.EbConfig] and
  ...
  implicit def jsonReadsIonrollerAPIServiceCurrentState: play.api.libs.json.Reads[ServiceCurrentState] = {
    (__ \ "environments").read[Seq[com.gilt.ionroller.api.v0.models.Environment]].map { x => new ServiceCurrentState(environments = x) }
  }
  ...
  implicit def jsonReadsIonrollerAPIServiceDesiredState: play.api.libs.json.Reads[ServiceDesiredState] = {
    (
      (__ \ "current").readNullable[com.gilt.ionroller.api.v0.models.Release] and
        (__ \ "next").readNullable[com.gilt.ionroller.api.v0.models.Release] and
        (__ \ "future").readNullable[com.gilt.ionroller.api.v0.models.Release]
  ...
  implicit def jsonWritesIonrollerAPIServiceDesiredState: play.api.libs.json.Writes[ServiceDesiredState] = {
    (
      (__ \ "current").writeNullable[com.gilt.ionroller.api.v0.models.Release] and
        (__ \ "next").writeNullable[com.gilt.ionroller.api.v0.models.Release] and
        (__ \ "future").writeNullable[com.gilt.ionroller.api.v0.models.Release]
      )(unlift(ServiceDesiredState.unapply _))
  }

  implicit def jsonReadsIonrollerAPIServiceState: play.api.libs.json.Reads[ServiceState] = {
    (
      (__ \ "current").read[com.gilt.ionroller.api.v0.models.ServiceCurrentState] and
        (__ \ "desired").readNullable[com.gilt.ionroller.api.v0.models.ServiceDesiredState]
      )(ServiceState.apply _)
  }

  implicit def jsonWritesIonrollerAPIServiceState: play.api.libs.json.Writes[ServiceState] = {
    (
      (__ \ "current").write[com.gilt.ionroller.api.v0.models.ServiceCurrentState] and
        (__ \ "desired").writeNullable[com.gilt.ionroller.api.v0.models.ServiceDesiredState]
...
package com.gilt.ionroller.api.v0 {
...
object Constants {
  ...
  val UserAgent = "apidoc:0.9.29 http://www.apidoc.me/gilt/ionroller-api/0.0.2-dev/ning_1_9_client"
...
class Client(
              apiUrl: String,
              auth: scala.Option[com.gilt.ionroller.api.v0.Authorization] = None,
  ...
  object Services extends Services {
    override def get()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.ionroller.api.v0.models.Service]] = {
      _executeRequest("GET", s"/services").map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Seq[com.gilt.ionroller.api.v0.models.Service]", r, _.validate[Seq[com.gilt.ionroller.api.v0.models.Service]])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }

    override def getByServiceName(
                                   serviceName: String
                                   )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.ionroller.api.v0.models.Service] = {
      _executeRequest("GET", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}").map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("com.gilt.ionroller.api.v0.models.Service", r, _.validate[com.gilt.ionroller.api.v0.models.Service])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def putConfigByServiceName(
                                         serviceName: String,
                                         serviceConfig: com.gilt.ionroller.api.v0.models.ServiceConfig
                                         )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit] = {
      val payload = play.api.libs.json.Json.toJson(serviceConfig)

      _executeRequest("PUT", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/config", body = Some(payload)).map {
        case r if r.getStatusCode == 204 => Unit
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def getConfigsByServiceName(
                                          ...
                                          )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.ionroller.api.v0.models.ServiceConfig]] = {
      ...
      _executeRequest("GET", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/configs", queryParameters = queryParameters).map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Seq[com.gilt.ionroller.api.v0.models.ServiceConfig]", r, _.validate[Seq[com.gilt.ionroller.api.v0.models.ServiceConfig]])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def getConfigByServiceName(
                                         serviceName: String
                                         )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.ionroller.api.v0.models.ServiceConfig] = {
      _executeRequest("GET", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/config").map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("com.gilt.ionroller.api.v0.models.ServiceConfig", r, _.validate[com.gilt.ionroller.api.v0.models.ServiceConfig])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def getConfigsByServiceNameAndTimestamp(
      ...
      _executeRequest("GET", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/configs/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(timestamp), "UTF-8")}").map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("com.gilt.ionroller.api.v0.models.ServiceConfig", r, _.validate[com.gilt.ionroller.api.v0.models.ServiceConfig])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def deleteConfigByServiceName(
      ...
      _executeRequest("DELETE", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/config").map {
        case r if r.getStatusCode == 204 => Unit
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def postReleaseByServiceName(
      ...
      _executeRequest("POST", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/release", body = Some(payload)).map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Long", r, _.validate[Long])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
    ...
    override def postDropByServiceName(
      ...
      _executeRequest("POST", s"/services/${_root_.com.gilt.ionroller.api.v0.PathSegment.encode(serviceName, "UTF-8")}/drop", body = Some(payload)).map {
        case r if r.getStatusCode == 200 => _root_.com.gilt.ionroller.api.v0.Client.parseJson("Long", r, _.validate[Long])
        case r => throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
  ...
  def parseJson[T](
    ...
    f(play.api.libs.json.Json.parse(r.getResponseBody("UTF-8"))) match {
      ...
      case play.api.libs.json.JsError(errors) => {
        throw new com.gilt.ionroller.api.v0.errors.FailedRequest(r.getStatusCode, s"Invalid json for class[" + className + "]: " + errors.mkString(" "), requestUri = Some(r.getUri.toJavaNetURI))
      }
    }
  }
...
trait Services {
   ...
   * Lists all services
   */
  def get()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.ionroller.api.v0.models.Service]]
